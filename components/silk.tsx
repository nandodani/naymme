...
interface SilkUniforms extends Record<string, IUniform> {
...
export default function Silk({
  ...
  const uniforms = useMemo<SilkUniforms>(
    ...
    // Props are synced in the effect below — the uniforms object must be
    // created once so the shader isn't rebuilt on every prop change.
    [],
  );
