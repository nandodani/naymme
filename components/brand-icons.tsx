...
/**
 * Brand glyphs for the availability matrix. Path data from Simple Icons
 * (CC0, https://simpleicons.org) — each is a 24x24 currentColor fill so the
 * row controls color through `text-*` classes.
 */
