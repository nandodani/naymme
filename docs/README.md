...
| [mcp-registry.md](mcp-registry.md)             | npm package layout and the publish checklist for the official MCP registry, Smithery and catalogues — plus per-client install config. |
